  ...
  <div class="d-flex flex-row w-100 navbar p-0">
    ...
    <div class="d-flex align-items-center w-100 h-100">
      ...
      <div class="d-flex col-6" style="justify-content: center;">
        <router-link to="/">
          <div class="navbar-item d-flex py-2 mx-1">
            ...
            <div class="d-flex align-items-center mx-2" style="color: #9d9d9d;">Phả đồ</div>
          </div>
        </router-link>
        <div @mouseenter="expandFamilyInfo = true" @mouseleave="expandFamilyInfo = false"
          class="navbar-item d-flex py-2 mx-1 position-relative" :class="{ chosen: infovalue }">
          ...
          <div class="navbar-item-content d-flex align-items-center">
            <router-link to="/information/headlist">
              <div class="mx-2" style="color: #9d9d9d;">Thông tin dòng họ</div>
            </router-link>
            <div class="navbar-extended d-flex flex-column w-100" :class="{ expandContent: expandFamilyInfo }">
              <router-link to="/information/headlist">
                <div :class="{ chosen: headlistvalue }" v-show="expandFamilyInfo" class="navbar-extended-content p-2 m-1">
        ...
        <div @mouseenter="expandMemberList = true" @mouseleave="expandMemberList = false"
          class="navbar-item d-flex py-2 mx-1">
          <!-- <svg class="navbar-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
            <path
          ...
          <div class="navbar-item-content d-flex align-items-center">
            <div class="mx-2" style="color: #9d9d9d;">Danh sách thành viên</div>
          </div>
        </div>
        <div @mouseenter="expandEventList = true" @mouseleave="expandEventList = false"
          class="navbar-item d-flex py-2 mx-1">
          <!-- <svg class="navbar-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
          ...
          <div class="navbar-item-content d-flex align-items-center">
            <div class="mx-2" style="color: #9d9d9d;">Sự kiện dòng họ</div>
          </div>
        </div>
      </div>
      <div class="col-2 d-flex align-items-center" style="justify-content: right; padding-right: 1.5rem;">
        ...
        <div class="navbar-item-content d-flex flex-row justify-content-center">
          <div @mouseenter="expandAccountManage = true" @mouseleave="expandAccountManage = false"
            ...
            <div class="navbar-item-content d-flex align-items-center">
              <div class="d-flex align-items-center p-2" style="justify-content: right;">Tên người dùng</div>
