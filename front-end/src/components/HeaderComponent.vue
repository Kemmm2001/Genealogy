  ...
  <div class="d-flex flex-row w-100 p-0 position-relative" style="z-index: 100;">
    <div class="d-flex align-items-center navbar px-3 py-0 w-100 h-100">
      ...
      <div class="d-flex col-7" style="padding-left: 50px; justify-content: left;">
        ...
        <div @mouseenter="expandFamilyInfo = true" @mouseleave="expandFamilyInfo = false" class="navbar-item d-flex position-relative" style="margin-left: 8px" :class="{ 'header-selected': currentPath === '/information/history' || currentPath === '/information/albumlist' || currentPath === '/information/history' || currentPath === '/information/statistics' }">
          <router-link to="/information/history" class="w-100 h-100 d-flex flex-row align-items-center">
            <div @click="setSelectedHead('/information/history')" class="d-flex flex-row align-items-center">
              ...
              <div :class="{ 'header-selected': currentPath === '/information/history' }" class="mx-2 navbar-text">
                Thông
                tin dòng họ
              </div>
            </div>
        ...
        <div :class="{ 'header-selected': currentPath === '/memberlist' }" @click="setSelectedHead('/memberlist')" @mouseenter="expandMemberList = true" @mouseleave="expandMemberList = false" class="navbar-item d-flex" style="margin-left: 8px">
        ...
        <div :class="{ 'header-selected': currentPath === '/event' }" @click="setSelectedHead('/event')" @mouseenter="expandEventList = true" @mouseleave="expandEventList = false" class="navbar-item d-flex" style="margin-left: 8px">
      ...
      <div class="col-2 d-flex align-items-center" style="justify-content: right;">
        ...
        <div class="navbar-item-content d-flex flex-row justify-content-center">
          <div :class="{ 'header-selected': currentPath === '/profile' }" @mouseenter="expandAccountManage = true" @mouseleave="expandAccountManage = false" class="navbar-item d-flex flex-row p-2 mx-2 position-relative align-items-center" style="margin-left: 8px">
            ...
            <div :class="{ 'header-selected': currentPath === '/profile' }" class="navbar-item-content d-flex align-items-center">
