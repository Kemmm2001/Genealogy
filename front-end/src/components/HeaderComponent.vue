    ...
    <div class="d-flex align-items-center navbar px-3 py-0 w-100 h-100">
      <div class="d-flex col-3" style="height: 64px; justify-content: left;">
        <router-link to="/" class="w-100">
          <div class="d-flex align-items-center w-100 h-100" style="justify-content: left; ">
            <div class="h-100 w-100" style="padding-left: 16px;">
      ...
      <div class="d-flex col-7" style="padding-left: 50px; justify-content: left;">
        ...
        <div @mouseenter="expandFamilyInfo = true" @mouseleave="expandFamilyInfo = false"
          ...
          :class="{ 'header-selected': currentPath === '/information/headlist' || currentPath === '/information/albumlist' || currentPath === '/information/history' || currentPath === '/information/statistics' }">
          <!-- <div @click="setSelectedHead('/information/headlist')" class="navbar-item-content d-flex align-items-center"> -->
          <router-link to="/information/headlist" class="w-100 h-100 d-flex flex-row align-items-center">
            <div @click="setSelectedHead('/information/headlist')" class="d-flex flex-row align-items-center">
              <svg class="navbar-icon-sm" style="margin-left: 8px;" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 512">
                <path
              ...
              <div :class="{ 'header-selected': currentPath === '/information/headlist' }" class="mx-2 navbar-text">Thông
                tin
                dòng họ</div>
            </div>
          </router-link>
          ...
          <div class="navbar-extended d-flex flex-column w-100" :class="{ expandContent: expandFamilyInfo }">
            ...
            <router-link to="/information/history">
              <div @click="setSelectedHead('/information/history')"
                :class="{ 'header-selected': currentPath === '/information/history' }" v-show="expandFamilyInfo"
                class="navbar-extended-content p-2 m-1">Lịch sử dòng họ</div>
            </router-link>
            <router-link to="/information/albumlist">
              <div @click="setSelectedHead('/information/albumlist')"
                :class="{ 'header-selected': currentPath === '/information/albumlist' }" v-show="expandFamilyInfo"
            ...
            <router-link to="/information/statistics">
              <div @click="setSelectedHead('/information/statistics')"
                :class="{ 'header-selected': currentPath === '/information/statistics' }" v-show="expandFamilyInfo"
                class="navbar-extended-content p-2 m-1">Thống kê dòng họ</div>
            </router-link>
          </div>
        </div>
        <div :class="{ 'header-selected': currentPath === '/memberlist' }" @click="setSelectedHead('/memberlist')"
          @mouseenter="expandMemberList = true" @mouseleave="expandMemberList = false" class="navbar-item d-flex"
          style="margin-left: 8px">
          <router-link to="/memberList" class="h-100 w-100 d-flex flex-row align-items-center">
            <svg class="navbar-icon-sm" style="margin-left: 8px;" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 384 512">
              <path
        ...
        <div :class="{ 'header-selected': currentPath === '/event' }" @click="setSelectedHead('/event')"
          @mouseenter="expandEventList = true" @mouseleave="expandEventList = false" class="navbar-item d-flex"
          style="margin-left: 8px">
          <router-link to="/event" class="h-100 w-100 d-flex flex-row align-items-center">
            <svg class="navbar-icon-sm" style="margin-left: 8px;" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512">
              <path
      ...
      <div class="col-2 d-flex align-items-center" style="justify-content: right;">
        <div @click="darkMode = !darkMode" class="d-flex" style="justify-content: center;">
          <button class="btn p-0" style="border: none; outline: none;">
            <svg v-if="!darkMode" class="night-icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
            ...
            <svg v-if="darkMode" class="day-icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
              height="36px" viewBox="0 0 24 24" width="36px" fill="#FFFFFF">
              <rect fill="none" height="24" width="24" />
              <path
        ...
        <div class="navbar-item-content d-flex flex-row justify-content-center">
          <div @mouseenter="expandAccountManage = true" @mouseleave="expandAccountManage = false"
            ...
            <div class="navbar-item-content d-flex align-items-center">
              <div v-if="AccountInfor" class="d-flex align-items-center navbar-text" style="justify-content: right;">
                {{
              ...
              <div class="user-extended d-flex flex-column position-absolute w-100"
                ...
                <div @click="LogoutGenelogy()">
                  <div v-show="expandAccountManage" class="navbar-extended-content p-2 m-1">Đăng xuất gia phả</div>
                </div>
                <div @click="LogoutAccount()">
                  <div v-show="expandAccountManage" class="navbar-extended-content p-2 m-1">Đăng xuất tài khoản</div>
                </div>
              </div>
            </div>
          </div>
