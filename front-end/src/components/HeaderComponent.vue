  ...
  <div class="d-flex flex-row w-100 p-0">
    <div class="d-flex align-items-center navbar px-3 py-0 w-100 h-100">
      ...
      <div class="d-flex col-7" style="padding-left: 50px; justify-content: left;">
        <router-link to="/">
          <div :class="{ 'header-selected': currentPath === '/' }" @click="setSelectedHead('/')" class="navbar-item d-flex py-2">
        ...
        <div @mouseenter="expandFamilyInfo = true" @mouseleave="expandFamilyInfo = false" class="navbar-item d-flex py-2 position-relative" style="margin-left: 8px"
         @click="setSelectedHead('/information/headlist')" :class="{ 'header-selected': currentPath === '/information/headlist' || currentPath === '/information/albumlist' || currentPath === '/information/articlelist' }">
          ...
          <div class="navbar-item-content d-flex align-items-center">
            <router-link to="/information/headlist">
              <div class="mx-2 navbar-text">Thông tin dòng họ</div>
            </router-link>
            <div class="navbar-extended d-flex flex-column w-100" :class="{ expandContent: expandFamilyInfo }">
              <router-link to="/information/headlist">
                <div @click="setSelectedHead('/information/headlist')" :class="{ 'header-selected': currentPath === '/information/headlist' }" v-show="expandFamilyInfo" class="navbar-extended-content p-2 m-1">Danh sách tộc trưởng</div>
              </router-link>
        ...
        <div :class="{ 'header-selected': currentPath === '/memberlist' }" @click="setSelectedHead('/memberlist')" @mouseenter="expandMemberList = true" @mouseleave="expandMemberList = false" class="navbar-item d-flex py-2" style="margin-left: 8px">
        ...
        <div :class="{ 'header-selected': currentPath === '/event' }" @click="setSelectedHead('/event')" @mouseenter="expandEventList = true" @mouseleave="expandEventList = false" class="navbar-item d-flex py-2" style="margin-left: 8px">
      ...
      <div class="col-2 d-flex align-items-center" style="justify-content: right;">
        <div @click="darkMode = !darkMode" class="d-flex" style="justify-content: center;">
          <button class="btn p-0">
            <svg v-if="!darkMode" class="day-night-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
            ...
            <svg v-if="darkMode" class="day-night-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <div class="navbar-item-content d-flex flex-row justify-content-center">
          <div @mouseenter="expandAccountManage = true" @mouseleave="expandAccountManage = false" class="navbar-item d-flex flex-row p-2 mx-2 position-relative align-items-center" style="margin-left: 8px">
            ...
            <div class="navbar-item-content d-flex align-items-center">
              <div v-if="AccountInfor" class="d-flex align-items-center navbar-text" style="justify-content: right;">{{ AccountInfor.username }}</div>
