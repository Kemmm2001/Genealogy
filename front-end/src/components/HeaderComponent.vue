  ...
  <div class="d-flex flex-row w-100 navbar p-0">
    ...
    <div class="d-flex align-items-center w-100 h-100">
      ...
      <div class="d-flex" style="flex-grow: 1; justify-content: center;">
        <div @mouseenter="expandFamilyInfo = true" @mouseleave="expandFamilyInfo = false" class="navbar-item d-flex p-2 mx-2 position-relative">
        ...
        <div @mouseenter="expandMemberList = true" @mouseleave="expandMemberList = false" class="navbar-item d-flex p-2 mx-2">
          ...
          <div class="navbar-item-content d-flex align-items-center">
            <div class="mx-2">Danh sách thành viên</div>
          </div>
        </div>
        <div @mouseenter="expandEventList = true" @mouseleave="expandEventList = false" class="navbar-item d-flex p-2 mx-2">
          ...
          <div class="navbar-item-content d-flex align-items-center">
            <div class="mx-2">Sự kiện dòng họ</div>
          </div>
        </div>
      </div>
      <div class="d-flex align-items-center" style="justify-content: right;">
        <div class="navbar-item-content d-flex flex-row">
          ...
          <div @mouseenter="expandAccountManage = true" @mouseleave="expandAccountManage = false" class="navbar-item d-flex flex-row p-2 mx-2 position-relative align-items-center">
