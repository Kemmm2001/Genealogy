  ...
  <div class="navbar-grid-container w-100">
    ...
    <div class="navbar-item-select">
      ...
      <div @mouseenter="expandFamilyInfo = true;" @mouseleave="expandFamilyInfo = false;"
        class="d-flex align-items-center justify-content-center" style="padding-right: 10px;">
        <router-link to="/information/history" class="h-100 d-flex flex-row justify-content-center">
          <div class="h-100 d-flex align-items-center position-relative">
            <div
              ...
              @click="setSelectedHead('/information/history')" class="d-flex flex-row align-items-center navbar-item">
              <svg class="navbar-icon-sm" style="margin-left: 8px;" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 512">
                <path
      ...
      <div class="d-flex align-items-center" style="padding-right: 10px;">
        <router-link to="/memberList" class="h-100 w-100 d-flex flex-row align-items-center justify-content-center">
          <div @click="setSelectedHead('/memberList')" :class="{ 'header-selected': currentPath === '/memberList' }"
    ...
    <div class="navbar-item-theme-user">
      ...
      <div class="navbar-item-content d-flex flex-row justify-content-center position-relative">
        <div @mouseenter="expandAccountManage = true;" @mouseleave="expandAccountManage = false;"
          ...
          <div :class="{ 'header-selected': currentPath === '/profile' }" class="navbar-item d-flex flex-row w-100 p-1"
          ...
          <div class="user-extended d-flex flex-column position-absolute" :class="{ expandContent: expandAccountManage }">
            ...
            <div @click="LogoutGenelogy()">
              <div v-show="expandAccountManage" style="cursor: pointer;" class="navbar-extended-content p-2 m-1">
                Đăng xuất gia
                phả
              </div>
            </div>
...
export default {
  ...
  mounted() {
    ...
    console.log("local: " + localStorage.getItem("accountID"));
    this.$nextTick(() => {
