<template>
        ...
        <div class="navbar-item-theme-user">
            <div @click="darkMode = !darkMode" class="d-flex" style="justify-content: end; padding-right: 12px;">
                <button class="btn p-0" style="border: none; outline: none;">
                    ...
                    <svg v-if="darkMode" class="day-icon" xmlns="http://www.w3.org/2000/svg"
                        enable-background="new 0 0 24 24" height="36px" viewBox="0 0 24 24" width="36px" fill="#FFFFFF">
                        <rect fill="none" height="24" width="24" />
                        <path
                ...
                <div :class="{ 'header-selected': currentPath === '/profile' }"
                    ...
                    <div class="navbar-item d-flex flex-row w-100 p-1" style="overflow: hidden;">
                        ...
                        <div :class="{ 'header-selected': currentPath === '/profile' }"
                            ...
                            <div class="d-flex align-items-center navbar-text ellipsis-text w-100"
                                ...
                                phungvietkhoiphungvietkhoiphungvietkhoi
                                </div>
                        </div>
                    </div>
                    <div class="user-extended d-flex flex-column position-absolute"
                        ...
                        <router-link to="/profile">
                            <div :class="{ 'header-selected': currentPath === '/profile' }"
                                @click="setSelectedHead('/profile')" v-show="expandAccountManage"
    ...
    <div class="navbar-item-select">
      ...
      <div @mouseenter="expandFamilyInfo = true;" @mouseleave="expandFamilyInfo = false;" class="d-flex align-items-center justify-content-center">
        <router-link to="/information/history" class="h-100 d-flex flex-row justify-content-center">
          <div class="h-100 d-flex align-items-center position-relative">
        ...
        <div :class="{ 'header-selected': currentPath === '/profile' }" @mouseenter="expandAccountManage = true; show()" @mouseleave="expandAccountManage = false; show();" style="overflow-x: clip; padding-right: 20px;" class="position-relative align-items-center d-flex">
          <div class="navbar-item d-flex flex-row w-100 p-1" style="overflow: hidden;">
            ...
            <div :class="{ 'header-selected': currentPath === '/profile' }" class="navbar-item-content d-flex align-items-center w-100" style="overflow: hidden;">
              <!-- <div v-if="AccountInfor" class="d-flex align-items-center navbar-text"
              style="justify-content: right;">{{ AccountInfor.Username }}</div>-->
              <div class="d-flex align-items-center navbar-text ellipsis-text w-100" style="padding-left: 4px;">phungvietkhoiphungvietkhoiphungvietkhoi</div>
            </div>
          </div>
