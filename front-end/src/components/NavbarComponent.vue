    ...
    <div class="navbar-item-select">
      ...
      <div class="d-flex align-items-center" style="padding-right: 10px;">
        <router-link to="/memberList" class="h-100 w-100 d-flex flex-row align-items-center justify-content-center">
          <div @click="setSelectedHead('/memberList')" :class="{ 'header-selected': currentPath === '/memberList' }" class="d-flex align-items-center navbar-item">
      ...
      <div class="d-flex align-items-center" style="padding-right: 10px;">
        <router-link to="/event" class="h-100 w-100 d-flex flex-row align-items-center justify-content-center">
          <div @click="setSelectedHead('/event')" :class="{ 'header-selected': currentPath === '/event' }" class="d-flex align-items-center navbar-item">
        ...
        <div @mouseenter="expandAccountManage = true;" @mouseleave="expandAccountManage = false;" style="padding-right: 20px; overflow: hidden;" class="align-items-center d-flex">
          ...
          <div class="user-extended d-flex flex-column position-absolute" :class="{ expandContent: expandAccountManage }">
            ...
            <div @click="LogoutGenelogy()">
              <div v-show="expandAccountManage" style="cursor: pointer;" class="navbar-extended-content p-2 m-1">Đăng xuất gia phả</div>
            </div>
            <div @click="LogoutAccount()">
              <div v-show="expandAccountManage" style="cursor: pointer;" class="navbar-extended-content p-2 m-1">Đăng xuất tài khoản</div>
            </div>
          </div>
        </div>
      </div>
