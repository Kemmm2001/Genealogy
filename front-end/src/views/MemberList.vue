                    ...
                    <div class="view-member w-100">
                        <div class="member" v-for="member in displayedItems" :key="member.id">
                            <div class="image-member" v-if="member.gender == 'male'">
                                <img src="https://pereaclinic.com/wp-content/uploads/2019/12/270x270-male-avatar.png"/>
                            </div>
                            <div class="image-member" v-if="member.gender == 'female'">
                                <img src="https://pereaclinic.com/wp-content/uploads/2019/12/270x270-female-avatar.png"/>
                            </div>
...
export default {
  data() {
    return{
        ...
        itemsPerPage: 6,  // Số mục dữ liệu trên mỗi trang
...
.sort-button button.btn.button-normal {
    width: 80px;
}
.title{
    padding-top:20px;
