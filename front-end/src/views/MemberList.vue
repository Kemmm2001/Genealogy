    ...
    <div class="d-flex flex-row position-absolute" style="width: calc(100% - 240px); height: calc(100% - 32px);">
      <div class="col-10 column m-0" style="height: calc(100% - 32px);">
        ...
        <div class="list-member w-100">
          <div v-if="memberRole != 3" class="button-member d-flex align-items-center">
            <button @click="openEditHeadModal()" class="btn bg-info text-white m-2" :disabled="isButtonDisabled">Chỉnh sửa</button>
          </div>
          <div class="view-member">
            ...
            <div v-if="memberList.length == 0" class="h-100 w-100 position-relative">
              <div style="inset: 0; margin: auto; position: absolute; height: fit-content; width: fit-content; font-size: 19px;">Gia phả chưa có thành viên nào</div>
            </div>
          </div>
        </div>
      </div>
