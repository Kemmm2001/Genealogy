<template>
    <div class="d-flex main-screen align-items-center">
        <div class="d-flex main-screen align-items-center">
          ...
          <div class="col-md-6 d-flex flex-row">
            ...
            <div class="d-flex flex-column col-md-8 align-items-center mx-1">
              <div class="d-flex flex-row align-items-center justify-content-around">
                <div class="col-md-12">
                  <input type="text" class="form-control modal-item mt-1" placeholder="Tên thành viên đầy đủ" />
                </div>
              </div>
              <div class="d-flex flex-row align-items-center justify-content-around">
                <div class="col-md-7">
                  <input type="text" class="form-control flex-grow modal-item mt-1" placeholder="Tên thường gọi" />
                </div>
                <div class="col-md-5">
              ...
              <div class="d-flex flex-row align-items-center justify-content-around">
                ...
                <div class="col-md-6 position-relative">
                  ...
                  <input id="birthorder" type="number" class="form-control flex-grow add-form-birthorder-input modal-item mt-1 pl-5" value="1" min="1" />
                </div>
              </div>
              ...
              <div class="d-flex flex-row align-items-center justify-content-center">
                <div class="col-md-12">
                  <input type="text" class="form-control flex-grow modal-item mt-1" placeholder="Nguyên quán" />
                </div>
              </div>
              <div class="d-flex flex-row align-items-center justify-content-center">
                <div class="col-md-12">
