        ...
        <div class="d-flex nonexisting-members flex-column w-100" style="margin-top: 4px">
          <div class="d-flex flex-row px-2 py-1" style="background-color: #AED6F1; ">
            <div class="d-flex align-items-center justify-content-center"
              style="text-align: center; border-radius: 0.175rem 0.175rem 0 0; min-height: 48px; font-size: 18px;">
              ...
              <div class="row">
                ...
                <div style="display:flex">
                  ...
                  <div style="position: relative;width: 50%; margin-right: 10px;">
                    ...
                    <label class="form-label-number" min="0" for="input" :class="{ 'active': objMemberJob.JobName }">
                      nghề
                      nghiệp
                    </label>
                  </div>
