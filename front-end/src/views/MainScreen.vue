  ...
  <div class="d-flex h-100 w-100 position-relative">
    <div class="list d-flex flex-column align-items-center">
      ...
      <div class="w-100 d-flex flex-row" style="padding-top: 8px">
        ...
        <div class="col-6 px-2">
          <div class="w-100">
            <button @click="openCompareModal()" style="width:100%" type="button"
              :class="{ 'btn': true, 'btn-secondary': !isCompare, 'btn-primary': isCompare }">So sánh</button>
          </div>
        </div>
      </div>
      <div class="h-100 w-100 d-flex flex-column px-2"
        style="padding-top: 8px; font-family: 'QuicksandBold', sans-serif;">
        ...
        <div class="d-flex nonexisting-members flex-column w-100" style="margin-top: 4px">
          <div class="d-flex flex-row px-2 py-1 list-title">
            ...
            <div class="d-flex align-items-center justify-content-center" style="padding-left: 12px;cursor:pointer"
    ...
    <div class="d-flex main-screen align-items-center w-100 positon-relative">
      ...
      <div :class="{ filterExpanded: advancedFilterDown }"
        class="advanced-filter-container d-flex flex-column p-1 position-absolute">
        ...
        <div @click="advancedFilterDown = !advancedFilterDown"
          class="p-2 d-flex align-items-center justify-content-center" style="height: 48px; cursor: pointer;">
          <div>
        ...
        <div class="card" style="width: 370px;left:45%">
          ...
          <div class="card-body" style="padding: 5px;height:auto">
            <div class="list-group">
              ...
              <div class="list-group-item" style="border-top: none;" @click="setPaternalAncestor(2)">Set làm tộc trưởng
              </div>
      ...
      <div class="h-100 d-flex flex-column" style="background-color: white;">
        ...
        <div class="d-flex flex-row" style="height: calc(100% - 50px)">
          <div class="col-3 h-100 d-flex flex-column" style="overflow-y: auto">
            ...
            <div>
              <div v-for="(n, index) in nodes" :key="n.id" :tabindex="index"
                class="noti-modal-member d-flex flex-row align-items-center px-2"
                :class="{ chosen: ListPhoneToSendMessage.includes(n.id) }" @click="toggleSelection(n.id)">
                <div>
          ...
          <div class="col-9 h-100 position-relative" style="background: #ebebeb">
            <div class="position-absolute w-100 d-flex flex-column" style="height: calc(100% - 64px); top: 0;">
              ...
              <div v-if="smsSelected" class="d-flex flex-column"
                style="height: calc(100% - 48px); align-items: flex-end; padding-top: 6px; overflow-y: auto">
            ...
            <div class="position-absolute w-100" style="bottom: 8px">
              <div v-if="smsSelected" class="w-100 px-3 d-flex flex-row">
                <input type="text" class="form-control" style="height: 48px;" placeholder="..."
              ...
              <div v-if="emailSelected" class="w-100 btn px-3 position-relative" style="height: 48px;">
                <div @click="expandCreateEmail = !expandCreateEmail" class="btn px-2 py-1 position-absolute"
                  style="right: 16px; background-color: #E8C77B;">Tạo email mới</div>
              </div>
            </div>
            <div class="position-absolute create-mail" :class="{ expanded: expandCreateEmail }">
              <div class="w-100 h-100 d-flex flex-column">
                ...
                <div class="create-mail-content px-2 w-100">
                  <textarea style="resize: none; outline: none; border: none;" class="h-100 w-100 p-2"
                ...
                <div class="create-mail-footer d-flex flex-row px-5 py-2 w-100" style="justify-content: end;">
                  ...
                  <div class="btn d-flex align-items-center justify-content-center"
                    style="padding: 4px 12px; background: #007bff; color: #FFFFFF; border-radius: 0">Gửi</div>
                ...
                <div class="d-flex flex-column" style="flex-grow: 1; padding-left: 8px;">
                  ...
                  <div class="d-flex flex-row pt-2">
                    ...
                    <div class="col-6" style="padding-left: 4px">
                      <input type="text" class="compare-modal-item form-control" :value="objCompareMember1.generation"
                        disabled />
                    </div>
                  </div>
                  <div class="pt-2">
                    <input type="text" class="compare-modal-item form-control"
                      :value="'Ngày Sinh: ' + objCompareMember1.dob" disabled />
                  </div>
                  <div class="pt-2">
              ...
              <div class="d-flex flex-column" style="flex-grow: 1; background-color: #f2f2f2;">
                <div class="compare-modal-item mx-2 mt-2">
                  <input type="text" class="w-100 h-100 form-control"
                    :value="objCompareMember1.father !== undefined ? objCompareMember1.father + ' (Bố)' : 'Không có trên phả đồ'"
                    disabled />
                </div>
                <div class="compare-modal-item mx-2 mt-2">
                  <input type="text" class="w-100 h-100 form-control"
                    :value="objCompareMember1.mother !== undefined ? objCompareMember1.mother + ' (Mẹ)' : 'Không có trên phả đồ'"
                    disabled />
                </div>
                <div class="compare-modal-item mx-2 mt-2">
                  <input type="text" class="w-100 h-100 form-control"
          ...
          <div class="col-6" style="padding: 0px 8px 48px 4px;">
            <div class="h-100 d-flex flex-column p-2" style="background-color: #FFFFFF; border-radius: 0.375rem;">
              <div class="d-flex flex-row pb-2" style="height: 220px">
                ...
                <div class="d-flex flex-column" style="flex-grow: 1; padding-left: 8px;">
                  ...
                  <div class="d-flex flex-row pt-2">
                    ...
                    <div class="col-6" style="padding-left: 4px">
                      <input type="text" class="compare-modal-item form-control" :value="objCompareMember2.generation"
                        disabled />
                    </div>
                  </div>
                  <div class="pt-2">
                    <input type="text" class="compare-modal-item form-control"
                      :value="'Ngày Sinh: ' + objCompareMember2.dob" disabled />
                  </div>
                  <div class="pt-2">
                    <input type="text" class="compare-modal-item form-control" value="Ngày mất (Nếu có)" disabled />
                  </div>
              ...
              <div class="d-flex flex-column" style="flex-grow: 1; background-color: #f2f2f2;">
                <div class="compare-modal-item mx-2 mt-2">
                  <input type="text" class="w-100 h-100 form-control"
                    :value="objCompareMember2.father !== undefined ? objCompareMember2.father + ' (Bố)' : 'Không có trên phả đồ'"
                    disabled />
                </div>
                <div class="compare-modal-item mx-2 mt-2">
                  <input type="text" class="w-100 h-100 form-control"
                    :value="objCompareMember2.mother !== undefined ? objCompareMember2.mother + ' (Mẹ)' : 'Không có trên phả đồ'"
                    disabled />
                </div>
                <div class="compare-modal-item mx-2 mt-2">
                  <input type="text" class="w-100 h-100 form-control"
        ...
        <div class="card h-100" v-if="objMemberInfor" style="border: none; position: relative;">
          ...
          <div class="card-footer modal-footer position-absolute w-100" style="bottom: 0;">
            <div class="d-flex justify-content-end" style="padding-right: 12px;">
              ...
              <button v-else-if="isEdit" type="button" class="btn btn-primary mr-2"
  ...
  methods: {
    ...
    getResultMember(id) {
      ...
      if (result.pids[0] != null) {
        ...
        objdata[result.gender === "male" ? "wife" : "husband"] = `Không có ${result.gender === "male" ? "vợ" : "chồng"
          }`;
      }
