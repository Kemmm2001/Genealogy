      ...
      <div class="h-100 w-100 d-flex flex-column px-2"
        ...
        <div class="existing-members d-flex flex-column w-100">
          <div class="d-flex align-items-center justify-content-center px-2 py-1"
            style="background-color: #AED6F1; text-align: center; border-radius: 0.175rem 0.175rem 0 0; min-height: 48px; font-size: 18px;">
            Thành viên có trên phả đồ</div>
        ...
        <div class="d-flex nonexisting-members flex-column w-100" style="margin-top: 4px">
          <div class="d-flex flex-row px-2 py-1" style="background-color: #AED6F1; ">
            <div class="d-flex align-items-center justify-content-center"
              style="text-align: center; border-radius: 0.175rem 0.175rem 0 0; min-height: 48px; font-size: 18px;">Thành
              viên không có trên phả đồ</div>
      ...
      <div :class="{ filterExpanded: advancedFilterDown }"
        ...
        <div class="p-2 d-flex align-items-center justify-content-center" style="height: 48px;">
          <div @click="advancedFilterDown = !advancedFilterDown" style="cursor: pointer;">
            <svg :class="{rotateDown : advancedFilterDown}" class="advanced-filter-icon" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512">
              <path
              ...
              <table class="table member headlist-list m-0">
                <thead>
                  <tr class="headlist-item">
                    ...
                    <th class="headlist-list-th">Quan hệ với thành viên</th>
                  </tr>
                </thead>
                <tbody style="cursor: pointer">
                  <tr v-for="(m, index) in ListUnspecifiedMembers" :key="m.id" @click="selectMemberFromTable(m, index)"
                    ...
                    <td class="d-flex justify-content-center">
                      <select class="form-control" style="text-align: center; width: 150px;">
                        <option>Cha</option>
                        <option>Mẹ</option>
                        <option>Vợ</option>
                        <option>Chồng</option>
