  ...
  <div class="members-grid-container">
    ...
    <div class="sorting-opts">
      ...
      <div class="opts d-flex align-items-center justify-content-center">
        <div class>
          <div @click="clickGenSort()" :class="{ 'bg-primary': genSort, 'bg-secondary': !genSort }" class="btn text-white d-flex justify-content-center align-items-center p-1">
        ...
        <div class="ms-1">
          <div @click="clickDobSort()" :class="{ 'bg-primary': dobSort, 'bg-secondary': !dobSort }" class="btn text-white d-flex justify-content-center align-items-center p-1">
        ...
        <div class="pt-2">
          <div class="h-100 w-100">
            ...
            <div class="h-100 d-flex flex-wrap" style="overflow-y: auto;">
              <div @click="numberItemSelection(index), getInforMember(member.MemberID)" class="member me-3" style="cursor: pointer;" :class="{ choose: itemChoose === index }" v-for="(member, index) in memberFilter" :key="member.MemberID">
                ...
                <div class="h-100 p-2 d-flex align-items-center justify-content-center">
                  <div style="height: 40%; width: 100%;">
                    ...
                    <div @click="triggerFileInputClick()" v-else class="w-100 h-100 position-relative" style="border: 1px dashed #7a95cd; border-radius: 0.375rem; cursor: pointer;">
                      ...
                      <div style="color: #7a95cd; position: absolute; inset: 45% 0 0 0; margin: auto; height: fit-content; width: fit-content;">Ảnh thành viên</div>
                    </div>
                  </div>
                </div>
                <div class="d-flex align-items-center">
                  <div class="h-100 w-100 p-2 d-flex flex-column justify-content-evenly">
                    ...
                    <div class="mdl-item" style="display:flex">
                      <div class="pe-1" style="position: relative;width: 50%; ">
                        <input v-model="objMemberInfor.BirthOrder" type="number" min="0" class="form-control" placeholder />
                    ...
                    <div class="mdl-item form-group">
                      ...
                      <div style="display:flex">
                        <div class="pe-1" style="position: relative; width: 50%;">
                          <input v-model="objMemberInfor.Dob" type="date" class="form-control" placeholder @change="convertSolarToLunar()" />
                          <label class="form-label" for="input">Dương Lịch</label>
                        </div>
                        <div class="ps-1" style="position: relative;width: 50%; ">
                          <input v-model="objMemberInfor.LunarDob" type="date" class="form-control" placeholder @change="convertLunarToSolar()" />
        ...
        <div class="cfdel-mdl-container">
          ...
          <div class="mdl-body">
            <div class="cfdel-body">
              <div class="d-flex align-items-center justify-content-center">Bạn có chắc chắn muốn xóa thành viên {{ objMemberInfor.MemberName }}</div>
