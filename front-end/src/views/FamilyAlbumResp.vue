<template>
  <div class="album-grid-container">
    <div class="h-100 w-100" style="background-color: #f2f2f2; display: grid; grid-template-rows: 8% 8% 84%;">
      <div class="d-flex align-items-center w-100 p-2" style="font-weight: bold; max-height: 56px;">Album dòng họ</div>
      ...
      <div class="h-100 w-100 pt-2 d-flex flex-wrap" style="overflow-y: auto;">
        <div v-if="AlbumPhotoList.length == 0" class="h-100 w-100 position-relative">
          <div class="center-content">Bạn chưa tạo album nào</div>
        </div>
    ...
    <div class="view-detail-container">
      <modal name="view-detail-mdl">
        <div class="mdl-container">
          <div class="mdl-title">
            <div style="font-family: 'QuicksandBold'; font-size: 17px;">Thông tin chi tiết của album {{ albumPhoto.AlbumName }}</div>
        ...
        <div class="mdl-container">
                ...
                <div class="d-flex flex-row w-100 h-100" style="flex-wrap: wrap; overflow-y: auto; justify-content: center">
                  <div class="add-photo d-flex flex-row position-relative" v-for="(photo, index) in FamilyPhotoList" :key="index" @click="clickPhoto(index), getPhotoCurrentId(photo.PhotoID)">
                    <div class="w-100 h-100 d-flex align-items-center justify-content-center" style="background-color: #000;">
                      <img :src="photo.PhotoUrl" ref="imageRef" style="max-width: 100%; height: fit-content; max-height: 100%; cursor: pointer;" :class="{ fitHeight: listHeightLarger[index] }" />
                    </div>
          ...
          <div class="mdl-footer">
            <div class="h-100 d-flex align-items-center justify-content-end">
              ...
              <div class="pe-2">
                <button class="btn btn-danger text-white" :disabled="isButtonDisabledPhoto" @click="removeFamilyPhotoByPhotoId()">Xóa Ảnh</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="mdl-container">
          ...
          <div class="mdl-footer">
            <div class="h-100 d-flex align-items-center justify-content-end">
              ...
              <div class="pe-2">
                <button class="btn btn-danger text-white" :disabled="isButtonDisabledPhotoAdd" @click="removeFamilyPhotoAdd()">Xóa Ảnh</button>
              </div>
              <div class="pe-2">
