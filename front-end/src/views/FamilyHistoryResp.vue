<template>
    <div class="history-grid-container">
        <div class="search">
            <div class="pt-2 px-2 d-flex flex-row align-items-center justify-content-center" style="font-weight: bold;">Lịch
                sử gia phả</div>
            <div class="position-relative p-2 d-flex" style="max-height: 56px;">
                ...
                <div class="w-100">
                    <input v-model="keySearch" @change="searchHistory()" class="form-control px-5 py-0 w-100 h-100"
                        id="text-search" type="text" />
                </div>
            </div>
        ...
        <div class="content">
            <div v-if="listHistory" class="h-100 w-100 position-absolute p-2" style="top: 0; background-color: #f2f2f2;">
                <draggable :list="listHistory" :disabled="!enabled" class="list-group h-100" style="overflow-y: auto;"
                    ...
                    <div v-for="element in listHistory" :key="element.HistoryID" class="w-100"
                        :style="{ 'min-height': '10%', 'float': element.HistoryID % 2 === 0 ? 'right' : 'left' }">
            ...
            <div v-else class="h-100 w-100 position-absolute p-2"
                style="top: 0; right: 0; background-color: #f2f2f2;">
