        ...
        <div class="d-flex flex-column h-100 w-100">
            ...
            <div class="">
                <table class="table headlist-list m-0">
                    ...
                    <tbody>
                        <tr @click="getInforMember(familyhead.MemberID)" class="headlist-item headlist-table-item" v-for="(familyhead,index) in this.familyheadFilter" :key="familyhead.MemberID">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex flex-column headlist-list-container w-100">
                        <table class="table member headlist-list m-0">
                            ...
                            <tbody>
                                <tr @click="chooseMember(member.id),numberItemSelection(index)" :class="{selected: itemChoose === index}" class="headlist-item headlist-table-item" v-for="(member,index) in this.memberList" :key="member.id">
              ...
              c29.765,0,53.895-24.13,53.895-53.895C458.105,346.487,367.619,256,256,256z" />
                ...
                <div class="card-footer" style="background-color:#E8C77B">
                    <div class="d-flex justify-content-end">
                        ...
                        <button @click="removeFamilyHead()" style="margin-left:10px" type="button" class="btn btn-secondary">Xóa khỏi danh sách tộc trưởng</button>
                    </div>
                </div>
            </div>
        </modal>
