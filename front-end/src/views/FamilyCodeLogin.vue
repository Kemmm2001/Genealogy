        ...
        <div v-if="right" class="login-form h-100 d-flex flex-column align-items-center" style="left: 0;">
          <div class="d-flex flex-column align-items-center" style="margin: auto;">
            ...
            <div class="d-flex flex-column" style="width: 420px;">
              ...
              <div class="d-flex justify-content-center align-items-center" style="height: auto; width: auto;">
                <button @click="showLoginHistoryModal()" class="btn login-button" style="margin-right: 36px;">Lịch sử đăng
                  nhập</button>
    ...
    <modal name="loginhistory-modal">
      <div class="w-100 h-100 add-album-modal">
        <div class="d-flex flex-row w-100 align-items-center position-relative">
          <div class="col-md-12 modal-title d-flex align-items-center justify-content-center w-100">Lịch sử đăng nhập code
            gia tộc</div>
